...
class  Header extends Component {
    render() { 
        const mystyle = {
        fontFamily: 'Roboto Condensed',textTransform: "uppercase",backgroundImage: "linear-gradient(to top, #30cfd0 0%, #330867 80%)",borderRadius: "15px",borderStyle: "hidden",padding: "18px", textAlign: "center",width: "auto",
